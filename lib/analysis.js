...
export function analyzeICP(a) {
  ...
  else if (fat > 0)      { score += 2;  criterios.push({ok:false,   txt:"Faturamento < R$10k — fora do ICP de assessoria"}); }
  ...
  if (fat >= 10000) {
    ...
    prodDesc = "Faturamento abaixo de R$10k — fora do perfil de assessoria Método Axis.";
  } else {
...
export function buildDiagnostico(a, produto, plano) {
  ...
  return { metaSmart:{ meta90, meta180, meta90desc, meta180desc }, protocolos, planoExecucao, prioridades };
}
